<template>
  <el-dialog title="彩色宝石鉴定详情" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" ref="dataForm" label-width="80px">
      ...
      <el-form-item label="镶石材质"><el-input v-model="dataForm.inlaidStoneMaterial" disabled="disabled"></el-input></el-form-item>
      <el-form-item label="使用情况"><el-input v-model="dataForm.useCase" disabled="disabled"></el-input></el-form-item>
      <el-form-item label="附件"><el-input v-model="dataForm.enclosure" disabled="disabled"></el-input></el-form-item>
      <el-form-item label="附件照">
        <el-image
