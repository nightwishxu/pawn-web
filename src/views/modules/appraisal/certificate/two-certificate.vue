<template>
  <el-dialog title="二折页证书" :close-on-click-modal="false" :visible.sync="visible" width="100%">
    <div class="certificate_wrap">
      <div class="certificate_box flex_box">
        <div class="certificate_item" style="width: 50%;">
          <div class="item_header">
            <h3 class="title">艺术品基本信息</h3>
            <p class="intro">Basic Information Of Works Art</p>
          </div>
          <div class="certificate_info" style="width: 45%;float: left">
            ...
            <show-info-item title="鉴定托底价" :value="certificate.mainMaterial" />
          </div>
          <div class="certificate_info" style="width: 10%;float: left"></div>
          <div class="certificate_info" style="width: 45%;float: left">
            <show-info-item title="艺术品材质" value="Material" />
            <div class="sub_item flex_box" style="
                    margin-bottom: 0px;
                    height: 35px;
                    padding-bottom: 0px;
                    margin-top: -2px;
          ...
          <show-picture-two :showData="pictureData" />
        </div>
        <div class="certificate_item" style="width: 50%;">
          <div class="item_header">
...
<script>
  ...
  import showPictureTwo from './components/showPictureTwo'
